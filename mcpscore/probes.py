...
async def run_all_probes(
    ...
    *,
    ...
    async with (
        httpx2.AsyncClient(verify=client_ssl_context(), follow_redirects=True, headers=headers) as own_client,
        httpx2.AsyncClient(verify=client_ssl_context(), follow_redirects=True, headers=headers) as fresh_client,
        httpx2.AsyncClient(verify=client_ssl_context(), follow_redirects=True) as anon_client,
    ):
