...
Audit finished. PARTIAL score: 27/27 from 10 of 74 checks — not comparable to a full audit.
```

The score line carries the qualifier and the check count deliberately: `27/27`
...
what makes the ratio interpretable — 10 of 74 main-axis checks could run without
