...
| Rule ID | Name | Severity | Weight | Applies to |
|---|---|---|---|---|
| `pagination_tools_invalid_cursor` | Tools Invalid Pagination Cursor | MEDIUM | 2 | all versions |
| `pagination_resources_invalid_cursor` | Resources Invalid Pagination Cursor | MEDIUM | 2 | all versions |
| `pagination_resource_templates_invalid_cursor` | Resource Templates Invalid Pagination Cursor | MEDIUM | 2 | all versions |
| `pagination_prompts_invalid_cursor` | Prompts Invalid Pagination Cursor | MEDIUM | 2 | all versions |
