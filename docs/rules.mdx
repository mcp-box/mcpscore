...
| `readiness_2026_jsonrpc_batch_rejected` | Readiness 2026-07-28 - JSON-RPC batches rejected | MEDIUM | 2 | all versions |
| `readiness_2026_malformed_json_rejected` | Readiness 2026-07-28 - malformed JSON rejected | MEDIUM | 2 | all versions |
