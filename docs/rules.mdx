...
| `protocol_version_supported_versions_include_negotiated` | MCP Protocol Version - Supported Versions Include Negotiated | LOW | 1 | all versions |
...
| `tools_mcp_headers_not_sensitive` | Tools - MCP headers should not expose sensitive parameters | HIGH | 3 | 2026-07-28 – … |
