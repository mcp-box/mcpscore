...
scanning alert, annotated on the pull request that introduced it.
...
fingerprint of the rule and target, so a re-upload updates the alert instead
...
```json
{
  ...
  "locations": [{ "physicalLocation": { "artifactLocation": { "uri": "https://mcp.deepwiki.com/mcp" } } }],
  "partialFingerprints": { "mcpscoreFinding/v1": "f1dcb75c967781b90dfa2a3e693e639b" },
